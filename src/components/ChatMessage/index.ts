        ...
        ${this.messages.length === 0
          ...
          : this.messages.map((msg: any, i: number) => {
            ...
            return html`
              ...
              ${(this.loading && i === this.messages.length -1) ? html `
                <div class="messages__item">loading...</div>
              ` : html`
                <div class="messages__item">${unsafeHTML(this.markdown.render(msg._answer))}</div>
              `}
            `              
          })
          }
